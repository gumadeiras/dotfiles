...
function ot($request) {
	...
	$url = "http://www.openthesaurus.com/browse/" . clean_utf8($request) . "&format=application/json";
	// $url = "http://www.openthesaurus.de/synonyme/search?q=" . clean_utf8($request) . "&format=application/json";
